  ...
  return (
    <div className="max-w-4xl mx-auto p-3">
      <div className="space-y-3">
        {/* Google Account */}
        <div className="flex items-center justify-between p-3 border rounded-lg bg-card hover:bg-muted/50 transition-all duration-200">
          <div className="flex items-center space-x-3">
            ...
            <div className="flex-1">
              ...
              <div className="text-xs text-muted-foreground">
                {isProviderConnected('google') ? `${user.email}` : 'Not connected'}
              </div>
            </div>
          </div>
          {isProviderConnected('google') ? (
        ...
        <div className="flex items-center justify-between p-3 border rounded-lg bg-card hover:bg-muted/50 transition-all duration-200">
          <div className="flex items-center space-x-3">
            ...
            <div className="flex-1">
              ...
              <div className="text-xs text-muted-foreground">
                {isProviderConnected('github') ? `${user.email}` : 'Not connected'}
              </div>
            </div>
          </div>
          {isProviderConnected('github') ? (
        ...
        <div className="flex items-center justify-between p-3 border rounded-lg bg-card hover:bg-muted/50 transition-all duration-200">
          <div className="flex items-center space-x-3">
            ...
            <div className="flex-1">
              ...
              <div className="text-xs text-muted-foreground">
                {isProviderConnected('microsoft') ? `${user.email}` : 'Not connected'}
              </div>
            </div>
          </div>
          {isProviderConnected('microsoft') ? (
        ...
        <div className="p-3 bg-muted/30 rounded-lg">
          <p className="text-xs text-center text-muted-foreground">
            Link accounts for easier sign-in • You can disconnect anytime
          </p>
        </div>
      </div>
    </div>
